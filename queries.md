...
```sql
SELECT authors.id, authors.name, authors.nationality, authors.birth_year, books.title AS book_title
FROM authors
...
```sql
SELECT books.id, books.title, books.author_id, books.publisher_id, books.publish_date, authors.name AS author_name
FROM authors
...
```sql
SELECT books.title AS book_title, publishers.name AS publisher_name, publishers.location
FROM books
...
```sql
SELECT publishers.id, publishers.name, publishers.location, publishers.founded_year, books.title AS book_title
FROM publishers
...
```sql
SELECT books.id, books.title, books.author_id, books.publisher_id, publishers.name AS publisher_name
FROM publishers
...
ORDER BY authors.id, books.id, publishers.id;
```
